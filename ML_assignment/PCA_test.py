...
if __name__=='__main__':
    ...
    print('输入数据集1的维度',dataMat1.shape)
    print('输入数据集2的维度',dataMat2.shape)
    lowDDataMat1=pca(dataMat1,4)
    lowDDataMat2=pca(dataMat2,4)
    print('降维后数据集1的维度',lowDDataMat1.shape)
    print('降维后数据集2的维度',lowDDataMat2.shape)
